...
<!--should section mention additional overly consistent exclusions and self-reported honesty checks?-->
 ...
 * "Omega_h... not meaningful": omega_h is undefined when computing a one-factor solution; omega_t remains valid and is the relevant statistic reported.
 So I don't think we need to do anything but suppressing these?
 -->
